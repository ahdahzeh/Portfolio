...
/**
 * Option A — Featured card + editorial index.
 * One large card (the headliner essay) on the left, a quiet perlera-style
 * title + date list on the right.
 */
export default function ThoughtsSectionA() {
  const [featured, ...rest] = thoughts;

  return (
    <section className="w-full" aria-labelledby="thoughts-a-heading">
      <div className="flex items-end justify-between mb-8 md:mb-10 gap-6">
        <div>
          <h2
            id="thoughts-a-heading"
